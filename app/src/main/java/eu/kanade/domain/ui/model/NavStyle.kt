package eu.kanade.domain.ui.model
  ...
  import eu.kanade.tachiyomi.ui.library.lightnovel.LightNovelLibraryTab
  ...
  enum class NavStyle(
      ...
      MOVE_LN_TO_MORE(titleRes = AYMR.strings.pref_bottom_nav_no_ln, moreTab = LightNovelLibraryTab),
      ...
      val moreIcon: ImageVector
          ...
          get() = when (this) {
              ...
              MOVE_LN_TO_MORE -> Icons.Outlined.AutoStories
